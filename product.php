					...
					<ul class="cate">
						<?php if (!empty($list_category_product)): ?>
							<?php foreach ($list_category_product as $key => $value): ?>
										<li><a href="<?php echo $baseurl ?>home.php?product_category=<?php echo $value->id  ?>"><?php echo $value->name_category ?></a></li>
							<?php endforeach ?>
						<?php endif ?>					</ul>
				</div>
						...
						<?php foreach ($list_product as $key => $value): ?>
							<div class="col-md-4 products-right-grids-bottom-grid">
								<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">
									...
									<h4><a href="single.html"><?php echo $value->nama_product; ?></a></h4>
